...
const ContactsContainer = () => {
  ...
  const {directMessagesContacts, setDirectMessagesContacts, contactsFetched, channels,channelsFatched, setChannels, setChannnelsFatched} = useAppStore();
